      ...
      if (typeof self.tables[id] === "undefined") {
        if (typeof options === "undefined") {
          options = {
            ...
            autoWidth: true,
            language: {
              emptyTable: el.data("lang-empty-table")
                ? el.data("lang-empty-table")
                : "No records found",
            },
          };
        }
...
jQuery(document).ready(function () {
  jQuery("#order-digit").find("input").not(".no-icheck").iCheck({
    inheritID: true,
  ...
  if (
    jQuery("#applyCreditContainer").data("apply-credit") === 1 &&
    useFullCreditOnCheckout.length
  ) {
