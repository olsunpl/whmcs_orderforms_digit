        ...
        <div class="domain-selection-options">
          ...
          {if $registerdomainenabled}
            <div class="option {if !$incartdomains} option-selected{/if}">
              <label>
                <input type="radio" name="domainoption" value="register" id="selregister" {if $domainoption eq "register"}
          ...
          {if $transferdomainenabled}
            <div class="option">
              <label>
                <input type="radio" name="domainoption" value="transfer" id="seltransfer" {if $domainoption eq "transfer"}
            ...
            <div class="option">
              <label>
                <input type="radio" name="domainoption" value="owndomain" id="selowndomain"
                  {if $domainoption eq "owndomain"} checked{/if} />{$LANG.cartexistingdomainchoice|sprintf2:$companyname}
              </label>
                    ...
                    <div class="row domains-row">
                      ...
                      <div class="col-xs-3 col-3">
                        <input type="text" id="owndomaintld" value="{$tld|substr:1}"
                          placeholder="{$LANG.yourtldplaceholder}" class="form-control" autocapitalize="none"
                          data-toggle="tooltip" data-placement="top" data-trigger="manual"
            ...
            <div class="option">
              <label>
                <input type="radio" name="domainoption" value="subdomain" id="selsubdomain"
                  {if $domainoption eq "subdomain"} checked{/if} />{$LANG.cartsubdomainchoice|sprintf2:$companyname}
              </label>
            ...
            <div id="primaryLookupResult" class="domain-lookup-result domain-lookup-primary-results w-hidden">
              <div class="domain-unavailable domain-checker-unavailable headline">
                <i style="transform: rotate(45deg);"
                  class="wdes-check-icon fad fa-plus-circle"></i>{lang key='orderForm.domainIsUnavailable'}
              </div>
              <div class="domain-available domain-checker-available headline"><i
                  class="wdes-check-icon fad fa-check-circle"></i>{$LANG.domainavailable1} <strong></strong>
                {$LANG.domainavailable2}</div>
              ...
              <div class="transfer-eligible">
                <p class="domain-checker-available headline"><i
                    class="wdes-check-icon fad fa-check-circle"></i>{lang key='orderForm.transferEligible'}</p>
              ...
              <div class="transfer-not-eligible">
                <p class="domain-checker-unavailable headline"><i style="transform: rotate(45deg);"
                    class="wdes-check-icon fad fa-plus-circle"></i>{lang key='orderForm.transferNotEligible'}</p>
              ...
              <div class="domain-invalid">
                <p class="domain-checker-unavailable headline"><i style="transform: rotate(45deg);"
                    class="wdes-check-icon fad fa-plus-circle"></i>{lang key='orderForm.domainInvalid'}</p>
                <p>
