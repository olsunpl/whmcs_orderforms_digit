<link rel="stylesheet" type="text/css" href="{$WEB_ROOT}/templates/orderforms/digit/css/all.min.css?v={$versionHash}" />
...
{/if}
<script type="text/javascript" src="{$WEB_ROOT}/templates/orderforms/digit/js/scripts.min.js?v={$versionHash}"></script>
{if $templatefile eq 'configureproductdomain'}
